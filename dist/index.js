...
exports.parse = __nccwpck_require__(8835).parse;
exports.resolve = __nccwpck_require__(8835).resolve;
...
var reAnsi        = __nccwpck_require__(5063)
  , stringifiable = __nccwpck_require__(8080)
...
var prettier_1 = __nccwpck_require__(2392);
...
var index_1 = __nccwpck_require__(495);
var AST_1 = __nccwpck_require__(9822);
var utils_1 = __nccwpck_require__(6269);
...
var formatter_1 = __nccwpck_require__(1917);
var generator_1 = __nccwpck_require__(2905);
var normalizer_1 = __nccwpck_require__(6106);
var optimizer_1 = __nccwpck_require__(8813);
var parser_1 = __nccwpck_require__(763);
var resolver_1 = __nccwpck_require__(1933);
var utils_1 = __nccwpck_require__(6269);
var validator_1 = __nccwpck_require__(9531);
var util_1 = __nccwpck_require__(1669);
var linker_1 = __nccwpck_require__(1789);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.link = void 0;
var JSONSchema_1 = __nccwpck_require__(4272);
var lodash_1 = __nccwpck_require__(250);
/**
...
var lodash_1 = __nccwpck_require__(250);
var util_1 = __nccwpck_require__(1669);
var typesOfSchema_1 = __nccwpck_require__(9649);
var AST_1 = __nccwpck_require__(9822);
var JSONSchema_1 = __nccwpck_require__(4272);
var utils_1 = __nccwpck_require__(6269);
...
var $RefParser = __nccwpck_require__(7676);
var utils_1 = __nccwpck_require__(6269);
...
function log(style, title) {
    ...
    console.info.apply(console, __spreadArrays([__nccwpck_require__(1047).whiteBright.bgCyan('debug'), (_a = getStyledTextForLogging(style)) === null || _a === void 0 ? void 0 : _a(title)], messages));
    if (lastMessage) {
...
function getStyledTextForLogging(style) {
    ...
    switch (style) {
        case 'blue':
            return __nccwpck_require__(1047).whiteBright.bgBlue;
        case 'cyan':
            return __nccwpck_require__(1047).whiteBright.bgCyan;
        case 'green':
            return __nccwpck_require__(1047).whiteBright.bgGreen;
        case 'magenta':
            return __nccwpck_require__(1047).whiteBright.bgMagenta;
        case 'red':
            return __nccwpck_require__(1047).whiteBright.bgRedBright;
        case 'white':
            return __nccwpck_require__(1047).black.bgWhite;
        case 'yellow':
            return __nccwpck_require__(1047).whiteBright.bgYellow;
    }
}
/**
...
module.exports = function (fn/*, options*/) {
	...
	if (options.refCounter) __nccwpck_require__(8789);
...
__nccwpck_require__.d(__webpack_exports__, {
  ...
  "joi2JsonSchema": () => /* binding */ joi2JsonSchema,
  "jsonSchema2Types": () => /* binding */ jsonSchema2Types
});

// EXTERNAL MODULE: ./node_modules/json-schema-to-typescript/dist/src/index.js
var src = __nccwpck_require__(495);
// CONCATENATED MODULE: ./src/transformer/object.ts

// @ts-ignore
const parser = (schema, options) => {
    const { type, $_terms, 
    // @ts-ignore
    _flags: { description, presence, unknown, } = {}, 
    // @ts-ignore
    _ids: { _byKey } = {}, } = schema;
    const properties = (($_terms === null || $_terms === void 0 ? void 0 : $_terms.keys) || []).map((propertySchema) => {
        ...
        return {
            key,
            property: src_transformer(schema, options),
        };
    }).reduce((acc, curr) => (Object.assign(Object.assign({}, acc), { [curr.key]: curr.property })), ($_terms === null || $_terms === void 0 ? void 0 : $_terms.keys) ? {} : null);
    return Object.assign(Object.assign(Object.assign({ type, additionalProperties: !!unknown }, (properties ? { properties } : {})), (description ? { description } : {})), (presence === 'required' && (_byKey === null || _byKey === void 0 ? void 0 : _byKey.size) > 0 ? { required: Array.from(_byKey.keys()) } : {}));
};
/* harmony default export */ const object = (parser);

// CONCATENATED MODULE: ./src/transformer/link.ts
// TODO
// @ts-ignore
const link_parser = (schema, options) => {
    const { $_terms, type } = schema;
...
/* harmony default export */ const transformer_link = (link_parser);
...
// CONCATENATED MODULE: ./src/transformer/alternatives.ts


// TODO
// @ts-ignore
const alternatives_parser = (schema, options) => {
    const { $_terms: { matches } = {}, _flags: { description, } = {}, } = schema;
    const oneOf = matches.map(({ schema }) => isSchema(schema) && src_transformer(schema)).filter(Boolean);
    return Object.assign({ oneOf }, (description ? { description } : {}));
};
/* harmony default export */ const alternatives = (alternatives_parser);

// CONCATENATED MODULE: ./src/transformer/string.ts
// @ts-ignore
const string_parser = (schema, options) => {
    var _a;
    const { type = 'string', 
    // @ts-ignore
    _valids, _flags: { description } = {}, } = schema;
    return Object.assign(Object.assign({ type }, (((_a = _valids === null || _valids === void 0 ? void 0 : _valids._values) === null || _a === void 0 ? void 0 : _a.size) > 0 ? { enum: Array.from(_valids._values) } : {})), (description ? { description } : {}));
};
/* harmony default export */ const string = (string_parser);

// CONCATENATED MODULE: ./src/transformer/function.ts
// @ts-ignore
const function_parser = (schema, options) => {
    const { $_terms, type, _flags: { description, } = {}, } = schema;
    return Object.assign({ instanceOf: 'Function', tsType: '(() => any)' }, (description ? { description } : {}));
};
/* harmony default export */ const transformer_function = (function_parser);

// CONCATENATED MODULE: ./src/transformer/array.ts

// @ts-ignore
const array_parser = (schema, options) => {
    const { $_terms } = schema;
    let items = $_terms.items;
    if (items[0]) {
        items = src_transformer(items[0], options);
    }
    return Object.assign({ type: schema.type || 'array' }, (((items === null || items === void 0 ? void 0 : items.length) > 0 || (items === null || items === void 0 ? void 0 : items.type)) ? { items } : {}));
};
/* harmony default export */ const array = (array_parser);

// CONCATENATED MODULE: ./src/transformer/index.ts
...
const transformer = (schema, options = defaultOptions) => {
    const typeMap = {
        object: object,
        string: string,
        function: transformer_function,
        array: array,
        alternatives: alternatives,
        link: transformer_link,
    };
    if ((schema === null || schema === void 0 ? void 0 : schema.type) && typeMap[schema === null || schema === void 0 ? void 0 : schema.type]) {
        return typeMap[schema.type](schema, Object.assign(Object.assign({}, defaultOptions), options));
    }
    const { type = 'any', 
    // @ts-ignore
    _flags: { description, } = {}, } = schema;
    return Object.assign({ type }, (description ? { description } : {}));
};
/* harmony default export */ const src_transformer = (transformer);
...
const jsonSchema2Types = src.compile;
const joi2JsonSchema = src_transformer;
...
/******/ 	return __nccwpck_require__(1548);
/******/ })()
;